      ...
      events: [
        {
          ...
          images: [
            "/images/Chapters/Rec/p2p/p2p-1.JPG",
            "/images/Chapters/Rec/p2p/p2p-2.JPG",
            "/images/Chapters/Rec/p2p/p2p-3.JPG",
            "/images/Chapters/Rec/p2p/p2p-4.JPG",
          ],
        },
        {
          title: "DevFest",
          ...
          images: [
            "/images/Chapters/Rec/Devfest/1.JPG",
            "/images//Chapters/Rec/Devfest/2.JPG",
            "/images//Chapters/Rec/Devfest/3.JPG",
            "/images//Chapters/Rec/Devfest/4.JPG",
            "/images//Chapters/Rec/Devfest/5.JPG",
            "/images//Chapters/Rec/Devfest/6.JPG",
            "/images//Chapters/Rec/Devfest/7.JPG",
            "/images//Chapters/Rec/Devfest/8.JPG",
            "/images//Chapters/Rec/Devfest/9.JPG",
            "/images//Chapters/Rec/Devfest/10.JPG",
            "/images//Chapters/Rec/Devfest/11.JPG",
            "/images//Chapters/Rec/Devfest/12.JPG",
          ],
        },
        {
          title: "Geekify U",
...
>
  ...
  >
    ...
    <span className="absolute inset-0 bg-cyan-950 translate-y-[100%] group-hover:translate-y-0 transition-transform duration-300"></span>
      ...
      <section ref={eventsRef} className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
          ...
          >
            ...
            <p className="text-gray-300 text-lg">Join us for our exciting events and be part of the tech revolution.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="p-6 bg-black/50 backdrop-blur-sm rounded-xl border border-gray-800 hover:border-green-400/50 transition-all hover:shadow-[0_0_15px_rgba(0,255,153,0.2)] group"
              >
                <h3 className="text-xl font-bold mb-2 group-hover:text-green-400 transition-colors">{event.title}</h3>
                ...
                <Button
                  variant="outline"
                  className="w-full border-green-500 text-green-400 hover:bg-green-950 hover:text-green-300"
                >
                  Register Now
                </Button>
              </motion.div>
      ...
      <section ref={sponsorsRef} className="py-20 bg-gradient-to-b from-black to-cyan-950/10">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="h-1 w-20 bg-cyan-400 mx-auto mb-6 glow-cyan"></div>
            <p className="text-gray-300 text-lg">
              We're grateful to our sponsors who make our events and initiatives possible
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((sponsor, index) => (
              <motion.div
                ...
                animate={sponsorsInView ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.5, delay: 0.1 * index }}
                className="flex items-center justify-center p-6 bg-black/50 backdrop-blur-sm rounded-xl border border-gray-800 hover:border-cyan-400/50 transition-all hover:shadow-[0_0_15px_rgba(13,202,240,0.2)]"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <form className="flex gap-2">
                <input
                  type="email"
                  className="flex-1 px-4 py-2 bg-black/50 border border-gray-700 rounded-lg focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400"
                  placeholder="Your email"
                />
                <Button
                  variant="outline"
